// 设置文件
import setting from './node_modules/@/setting.js.js'
...
export default {
  ...
  actions: {
     ...
     * @example
     // 折叠侧边栏菜单
     * this.$store.dispatch('cg-visual/menu/asideCollapseSet', false)
     // 展开侧边栏菜单
     * this.$store.dispatch('cg-visual/menu/asideCollapseSet', true)
     */
